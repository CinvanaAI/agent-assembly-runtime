...
from agent_assembly_runtime.agent_normalizer import AgentNormalizer
from agent_assembly_runtime.agent_paths import AgentPaths
from agent_assembly_runtime.agent_projection_writer import AgentProjectionWriter
from agent_assembly_runtime.agent_schema import OUTCASTS_GROUP_NAME, clean_text
from agent_assembly_runtime.agent_validator import AgentValidator
from agent_assembly_runtime.memory_file_manager import MemoryFileManager
...
class AssemblyManager:
    ...
    def __init__(self, assemblies_dir: str | Path) -> None:
        self.paths = AgentPaths(assemblies_dir)
